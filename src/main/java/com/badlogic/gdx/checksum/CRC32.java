...
public class CRC32 {
	...
	/**
	 * Lookup table generated with polynomial = reflect(0x04c11db7).
	 */
	...
	public boolean equals(Object object) {
		return (object instanceof CRC32) && equals((CRC32) object);
	}
	...
	public static CRC32 valueOf(int value) {
		return new CRC32(value);
	}

	public static CRC32 calculate(byte[] buffer) {
	...
	public static CRC32 update(CRC32 checksum, byte buffer[], int offset, int length) {
		...
		for (int i = offset; i < offset + length; ++i) {
			...
			checksum.value = (checksum.value >>> 8) ^ table[idx ^ (checksum.value & 0x000000ff)];
		}
	...
	public static int compare(CRC32 x, CRC32 y) {
